    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 px-6 lg:px-16 py-12 min-h-screen">
        <div className="text-text-base max-w-xl">
          <p className="uppercase tracking-[0.3em] text-sm text-text-muted mb-4">Plataforma de reclutamiento</p>
        ...
        <div className="w-full max-w-md rounded-2xl border border-glass-border bg-glass-card shadow-2xl p-8 backdrop-blur-2xl text-text-base">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full text-text-base border border-glass-border hover:bg-glass-card transition-colors font-medium rounded-lg text-sm px-5 py-3 text-center"
            >
              Registrarse
            </button>
          </form>
